...
-- Insert table users
-- ---------------------------------------------------------------------------
INSERT INTO `users` (`id_user`, `username`, `name`, `email`, `password`, `salt`, `session_id`, `session_expiry_time`) VALUES
...
-- ---------------------------------------------------------------------------
INSERT INTO `product_category` (`id_category`, `name`, `lft`, `rgt`) VALUES
(1, 'Dry', 1, 6),
(2, 'Herbs and Spices', 2, 5),
(3, 'Green Herbs', 3, 4),
(4, 'Meats', 7, 8);
