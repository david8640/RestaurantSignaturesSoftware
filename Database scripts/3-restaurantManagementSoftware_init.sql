...
-- ---------------------------------------------------------------------------
INSERT INTO `orderList` (`id_order`, `id_restaurant`, `dateOfOrder`, `subtotal`, 
	`shippingCost`, `taxes`, `totalCost`)
VALUES
...
-- Insert table POItem
-- ---------------------------------------------------------------------------
INSERT INTO `POItem` (`id_product`, `po_Number`, `dateOrdered`, `dateDelivered`, `cost`, `qty`)
VALUES
	(1, 1, '2014-01-19 18:55:55', '2014-01-19 18:55:55', 50, 10),
	(1, 2, '2014-01-19 18:55:55', '2014-01-19 18:55:55', 50, 10),
	(2, 3, '2014-01-19 18:55:55', '2014-01-19 18:55:55', 25, 10),
	(2, 4, '2014-01-19 18:55:55', '2014-01-19 18:55:55', 25, 10);
GO
